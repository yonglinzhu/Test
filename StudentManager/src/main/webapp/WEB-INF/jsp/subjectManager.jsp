        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <div style="margin-left: 20px;">
                    <a href="#add-subject" role="button" class="btn btn-xs btn-success" data-toggle="modal"> 添加学科 </a>
                </div>
            ...
            <!--弹出层 添加学科-->
            <div id="add-subject" class="modal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="blue bigger">添加学科</h4>
                        </div>
                        <form class="form-horizontal" role="form" action="saveSubject" method="post">
                            <div class="modal-body" style="margin-left: 60px">
                                <div class="form-group">
                                    <label>学科名称：</label>
                                    <input type="text" name="name" placeholder="填写学科名称"/>
                                </div>
                            </div>
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                            ...
                                            <td class="center">
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <a href="#update-subject" data-toggle="modal"
                                                       ...
                                                       title="修改学科信息"
                                                       onclick="updateSubjectInfo(${subject.id},'${subject.name}')">
                        ...
                        <!--弹出层 修改学科-->
                        <div id="update-subject" class="modal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="blue bigger">修改学科</h4>
                                    </div>
                                    <form class="form-horizontal" role="form" action="updateSubject" method="post">
                                        <%--学科ID--%>
                                        <input type="hidden" name="id" id="update-subject-id">
                                        <div class="modal-body" style="margin-left: 60px">
                                            <div class="form-group">
                                                <label>学科名称：</label>
                                                <input type="text" id="update-subject-name" name="name"
                                                       placeholder="填写学科名称"/>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
...
<script>
    /*初始化要修改的学科信息*/
    function updateSubjectInfo(id, name) {
        $("#update-subject-id").val(id);
        $("#update-subject-name").val(name);
    }
</script>
<script type="text/javascript">
    jQuery(function ($) {
        /*add subject*/
        $('#add-subject').on('shown.bs.modal', function () {
            if (!ace.vars['touch']) {
        ...
        /*update subject*/
        $('#update-subject').on('shown.bs.modal', function () {
            if (!ace.vars['touch']) {
                $(this).find('.chosen-container').each(function () {
                    $(this).find('a:first-child').css('width', '180px');
                    $(this).find('.chosen-drop').css('width', '180px');
