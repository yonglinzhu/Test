            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                            ...
                                            <td class="center">
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <a href="#entry-score" data-toggle="modal"
                                                       class="btn btn-xs btn-success" onclick="entryScore(${score.id})"
                                                       title="填写分数">
                        ...
                        <!--弹出层-->
                        <div id="entry-score" class="modal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" role="form" action="entryScore" method="post">
...
<script>
    /*初始化要修改的学科信息*/
    function entryScore(id) {
        $("#entry-score-id").val(id);
    }
</script>
<script type="text/javascript">
    jQuery(function ($) {
        /*add grade*/
        $('#entry-score').on('shown.bs.modal', function () {
            if (!ace.vars['touch']) {
