        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <div style="margin-left: 20px;">
                    <a href="#add-grade" role="button" class="btn btn-xs btn-success" data-toggle="modal">添加班级 </a>
                </div>
            ...
            <!--弹出层-->
            <div id="add-grade" class="modal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="blue bigger">添加班级</h4>
                        </div>
                        <form class="form-horizontal" role="form" action="saveGrade" method="post">
                            <div class="modal-body">
                                <div class="row">

                                    <div class="form-group ">
                                        <div style="width: 70%;margin: auto">
                                            <input type="text" name="classname" id="class-name" placeholder="填写班级名"
                                                   class="col-sm-7"/>
                                        </div>
                                    </div>
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <!--弹出层 修改班级信息-->
                        <div id="update-grade" class="modal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="blue bigger">修改班级信息</h4>
                                    </div>
                                    <form class="form-horizontal" role="form" action="updateGrade" method="post">
                                        <div class="modal-body">
                                            <div class="row">
                                                <input type="hidden" name="id" id="update-grade-id"/>
                                                <div class="form-group ">
                                                    <div style="width: 70%;margin: auto">
                                                        <input type="text" name="classname" id="update-grade-name"
                                                               placeholder="填写班级名" value=""
                                                               class="col-sm-7"/>
                                                    </div>
                                                </div>
...
<script>
    /*修改班级信息 - 初始化数据*/
    function updateGradeInfo(gradeName, id) {
        $("#update-grade-id").val(id);
        $("#update-grade-name").val(gradeName);
    }
</script>
<script type="text/javascript">
    ...
    jQuery(function ($) {
        /*add grade*/
        $('#add-grade').on('shown.bs.modal', function () {
            if (!ace.vars['touch']) {
        ...
        /*update grade*/
        $('#update-grade').on('shown.bs.modal', function () {
            if (!ace.vars['touch']) {
                $(this).find('.chosen-container').each(function () {
                    $(this).find('a:first-child').css('width', '180px');
                    $(this).find('.chosen-drop').css('width', '180px');
